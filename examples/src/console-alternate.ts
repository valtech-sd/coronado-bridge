 ...
 */
import OutboundConsoleStructuredResponse from './providers/OutboundConsoleStructuredResponse';
...
const config: IBridgeConfig = {
  ports: [3000, 3002],
  logger,
  outboundProvider: new OutboundConsoleStructuredResponse(logger),
};
